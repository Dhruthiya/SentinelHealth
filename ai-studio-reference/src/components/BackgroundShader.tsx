...
export const BackgroundShader: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full -z-20 pointer-events-none overflow-hidden" id="ambient-shader-container">
      <canvas
        ref={canvasRef}
